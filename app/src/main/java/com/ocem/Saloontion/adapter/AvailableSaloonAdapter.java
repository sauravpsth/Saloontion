...
public class AvailableSaloonAdapter  extends RecyclerView.Adapter<SaloonServiceAdapter.MyViewHolder> {
    Button button;
    Context mContext;
    List<ServicesResponse> servicesResponses;
    SharedPrefsHelper sharedPrefsHelper;

    public AvailableSaloonAdapter(Context mContext, List<ServicesResponse> servicesResponses) {
    ...
    @NonNull
    @Override
    public SaloonServiceAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View v;
        v = LayoutInflater.from( mContext ).inflate( R.layout.item_contact,parent,false );
        SaloonServiceAdapter.MyViewHolder vHolder = new SaloonServiceAdapter.MyViewHolder( v );
        return vHolder;
    ...
    @Override
    public void onBindViewHolder(@NonNull SaloonServiceAdapter.MyViewHolder holder, int position) {

            holder.tv_name.setText( servicesResponses.get( position ).getName() );
        ...
        Glide.with(mContext)
                .load("http://saloon.oxfordcollege.edu.np/" + servicesResponses.get( position ).getImage() )
        ...
        holder.button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.v("serviceid","check"+servicesResponses.get( position ).getServiceId());
